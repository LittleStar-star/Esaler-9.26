                ...
                <tr v-for="(item,index) in wishlist" :key="index">
                  <td class="product-thumbnail">
                    <a href="prodetail.html">
                      <img
                        v-lazy="item.imgPath ? URL_IMG + item.imgPath : URL_IMG + item.proes?.smsImg"
                        alt="Image"
                      />
                      <!-- <img
                  ...
                  <td class="product-name">
                    <a href="prodetail">{{item.productionNum?item.productionNum:item.proes?.smsProductionNum}}</a>
                  </td>
                  ...
                  <td>
                    <nuxt-link
                      :to="{name:'prodetail',
                      query:{id:item.productionId?item.productionId:item.proes?.smsProductionId,
                      pro:item.productionNum?item.productionNum:item.proes?.smsProductionNum,
                      maf:item.manufacturer?item.manufacturer:item.proes?.smsSupplier}}"
                      class="default-btn"
                    >Production Info</nuxt-link>
                  </td>
                  <td class="trash">
                    <a href="javascript:void(0)" class="remove" @click="del(index)">
